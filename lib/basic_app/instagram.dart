...
import 'package:projectinstagram/basic_app/ProfileMe.dart';
...
class _InstagramState extends State<Instagram> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _shouldHideAppBar() ? null : _buildAppBar(), // Hide AppBar conditionally
      body: _buildBody(),
  ...
  bool _shouldHideAppBar() {
    return _currentIndex == 1 || _currentIndex == 2 || _currentIndex == 3 || _currentIndex == 4;
  }
    ...
    return AppBar(
      actions: [
        ...
        InkWell(
          ...
          child: Image.network('https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/instagram-dm-direct-message-icon.png', width: 24, height: 20),
        ),
        const SizedBox(width: 8),
      ],
      title: const Text(
  ...
  Widget _profilePostfour() {
    return _buildPostfour(
      profileImage: 'https://www.nme.com/wp-content/uploads/2024/11/blackpink-rose-k-pop-fan-culture-trained-perfect-interview.jpg',
      username: 'ROSE',
      postImage: 'https://images.lifestyleasia.com/wp-content/uploads/sites/2/2024/11/19115013/untitled-design-2024-11-12t170849-678-1600x900.jpeg',
      caption: "Hello💙💙💙",
  ...
  Widget _profilePostfive() {
    return _buildPostfive(
      profileImage: 'https://media.femalemag.com.sg/public/2019/03/51021013_237686723851021_5419594866899599564_n-cc-768x960.jpg?compress=true&quality=80&w=480&dpr=2.6',
      username: 'LISA',
      postImage: 'https://imageio.forbes.com/specials-images/imageserve/66d61305ddcd33bb27d0c844/2022-Bulgari-Aurora-Awards-in-Seoul---Photo-Call/0x0.jpg?format=jpg&crop=2230,1486,x0,y100,safe&width=960',
