    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Image.network('https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Threads_%28app%29_logo.svg/2048px-Threads_%28app%29_logo.svg.png', width: 24, height: 20),
            SizedBox(width: 16),
                          ...
                          Padding(
                            ...
                            child: ClipOval(
                              child: SizedBox(
                                ...
                                height: 80,
                                child: Container(
                                  child: Image.network('https://pbs.twimg.com/profile_images/1302423818409975809/evBuVQa9_400x400.jpg'),
                                  //the same
